...
export default function ClassicPortfolio({gridClass,col,containerClass}){
                        ...
                        <div id="grid" className={gridClass}>
                            {filteredData.map((item,index) => {
                                ...
                                <div className="col picture-item" key={index}>
                                    <div className="card border-0 portfolio portfolio-primary portfolio-classic">
                                        <div className="card-body p-0">
                                            <Link to="#"  onClick={() => handleImageClick(item.id)}><img src={item.image} className="img-fluid rounded work-image" alt=""/></Link>
                                            <div className="pt-3">
